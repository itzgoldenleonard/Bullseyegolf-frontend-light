...
pub enum Error {
    InvalidQueryString,
    Network(reqwest::Error), // TODO: Maybe this needs to be split up into multiple kinds of errors
    Referer,
